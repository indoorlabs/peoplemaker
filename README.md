...
```
클립 5개(합성 기준 팩) · Rocketbox 사람 여덟(어른 여섯 · 어린이 둘) → 재서
카탈로그 → three.js 가 읽고 사람을 세운다
...
게이트 11개 · 검사 669 (살이 사람 모양인지·제 색인지·제 몸인지까지 잰다)
...
필요하다), **노인**(Rocketbox 에 없다 — 다른 출처가 필요하고 라이선스가 또
